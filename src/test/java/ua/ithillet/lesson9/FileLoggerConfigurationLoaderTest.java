...
public class FileLoggerConfigurationLoaderTest {
    ...
    public void checkTextFromFile() {
        ...
        Assertions.assertTrue(workWithLogFile.readTextFromFile(workWithLogFile.getPath(), "[DEBUG] Message: Debug message", workWithLogFile.getCurrentDate()).contains(workWithLogFile.getCurrentDate()));
    }
}
